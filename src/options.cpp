...
wxString GetOCPNKnownLanguage(wxString lang_canonical, wxString& lang_dir) {
  ...
  if (lang_canonical == _T("en_US")) {
    ...
    dir_suffix = _T("pt_PT");
    return_string = wxString("Portugu¨ºs", wxConvUTF8);

  } else if ((lang_canonical == _T("pt_BR")) || (lang_canonical == _T("pt_BR"))) {
    dir_suffix = _T("pt_BR");
    return_string = wxString("Portugu¨ºs  Brasileiro", wxConvUTF8);

  } else if ((lang_canonical == _T("ru_RU")) || (lang_canonical == _T("ru"))) {
    dir_suffix = _T("ru");
    return_string = wxString("§²§å§ã§ã§Ü§Ú§Û", wxConvUTF8);
    ...
    dir_suffix = _T("el_GR");
    return_string = wxString("¦¥¦Ë¦Ë¦Ç¦Í¦É¦Ê?", wxConvUTF8);
    ...
    dir_suffix = _T("zh_TW");
    return_string = wxString("·±Ìå×Ö", wxConvUTF8);
